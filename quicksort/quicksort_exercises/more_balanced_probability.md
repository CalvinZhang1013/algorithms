## Argue that for any constant 0 < alpha ≤ 0.5, the probability is approximately 1 - 2\*alpha that on a random input array, PARTITION produces a split more balanced than 1-alpha to alpha.
